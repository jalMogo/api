...
SOCIAL_AUTH_DISCOURSE_AUTH_SECRET = os.environ.get('SOCIAL_AUTH_DISCOURSE_AUTH_SECRET',
                                                   'NO_SOCIAL_AUTH_DISCOURSE_AUTH_SECRET')
SOCIAL_AUTH_DISCOURSE_AUTH_SERVER_URL = os.environ.get('SOCIAL_AUTH_DISCOURSE_AUTH_SERVER_URL',
                                                       'NO_SOCIAL_AUTH_DISCOURSE_AUTH_SERVER_URL')
