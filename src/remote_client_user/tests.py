...
class RemoteClientUserTests(TestCase):
    ...
    def test_no_auth_with_invalid_remote_auth_header_data(self):
        ...
        request.META["HTTP_AUTHORIZATION"] = (
            b"Remote " + base64.encodestring(b"skittles").strip()
        )
    ...
    def test_no_auth_with_nonexistant_client(self):
        ...
        request.META["HTTP_AUTHORIZATION"] = (
            b"Remote "
            + base64.encodestring(b"abc;123;mjumbewu;mjumbewu@example.com").strip()
        )
    ...
    def test_no_auth_with_client_with_no_permissions(self):
        ...
        user = User.objects.create_user(
            username="mjumbewu", email="mjumbewu@example.com", password="!"
        )
    ...
    def test_no_auth_with_client_with_no_signup_permissions(self):
        User = get_user_model()
        user = User.objects.create_user(
            username="dvalpey", email="dvalpey@example.com", password="!"
        )
    ...
    def test_auth_with_client_with_signup_permissions(self):
        ...
        ClientPermissions.objects.create(
            client=client, allow_remote_signin=True, allow_remote_signup=True
        )
