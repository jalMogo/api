...
urlpatterns = [
    url(r"^$", views.MapseedAPIRootView.as_view(), name="api-root"),
    url(
        r"^(?P<owner_username>[^/]+)/datasets/(?P<dataset_slug>[^/]+)/places/(?P<thing_id>\d+)/attachments$",
        views.AttachmentListView.as_view(),
        name="place-attachments",
    ),
    url(
        r"^(?P<owner_username>[^/]+)/datasets/(?P<dataset_slug>[^/]+)/places/(?P<place_id>\d+)/attachments/(?P<attachment_id>\d+)$",
        views.AttachmentInstanceView.as_view(),
        name="attachment-detail",
    ),
    url(
        r"^(?P<owner_username>[^/]+)/datasets/(?P<dataset_slug>[^/]+)/places/(?P<place_id>\d+)/(?P<submission_set_name>[^/]+)/(?P<thing_id>\d+)/attachments$",
        views.AttachmentListView.as_view(),
        name="submission-attachments",
    ),
    url(
        r"^(?P<owner_username>[^/]+)/datasets/(?P<dataset_slug>[^/]+)/actions$",
        views.ActionListView.as_view(),
        name="action-list",
    ),
    url(
        r"^(?P<owner_username>[^/]+)/datasets/(?P<dataset_slug>[^/]+)/metadata$",
        views.DataSetMetadataView.as_view(),
        name="dataset-metadata",
    ),
    # bulk data snapshots
    url(
        r"^(?P<owner_username>[^/]+)/datasets/(?P<dataset_slug>[^/]+)/(?P<submission_set_name>[^/]+)/snapshots$",
        views.DataSnapshotRequestListView.as_view(),
        name="dataset-snapshot-list",
    ),
    url(
        r"^(?P<owner_username>[^/]+)/datasets/(?P<dataset_slug>[^/]+)/(?P<submission_set_name>[^/]+)/snapshots/(?P<data_guid>[^/.]+)(:?\.(?P<format>[^/]+))?$",
        views.DataSnapshotInstanceView.as_view(),
        name="dataset-snapshot-instance",
    ),
    # flavors
    url(
        r"^flavors/(?P<flavor_slug>[^/]+)$",
        views.FlavorInstanceView.as_view(),
        name="flavor-detail",
    ),
    # place tags
    url(
        r"^(?P<owner_username>[^/]+)/datasets/(?P<dataset_slug>[^/]+)/places/(?P<place_id>\d+)/tags/(?P<place_tag_id>\d+)$",
        views.PlaceTagInstanceView.as_view(),
        name="place-tag-detail",
    ),
    url(
        r"^(?P<owner_username>[^/]+)/datasets/(?P<dataset_slug>[^/]+)/places/(?P<place_id>\d+)/tags$",
        views.PlaceTagListView.as_view(),
        name="place-tag-list",
    ),
    # submission sets (votes, comments)
    url(
        r"^(?P<owner_username>[^/]+)/datasets/(?P<dataset_slug>[^/]+)/places/(?P<place_id>\d+)/(?P<submission_set_name>[^/]+)/(?P<submission_id>\d+)$",
        views.SubmissionInstanceView.as_view(),
        name="submission-detail",
    ),
    url(
        r"^(?P<owner_username>[^/]+)/datasets/(?P<dataset_slug>[^/]+)/places/(?P<place_id>\d+)/(?P<submission_set_name>[^/]+)(?:/(?P<pk_list>(?:\d+,)+\d+))?$",
        views.SubmissionListView.as_view(),
        name="submission-list",
    ),
    url(
        r"^(?P<owner_username>[^/]+)/datasets/(?P<dataset_slug>[^/]+)/places/(?P<place_id>\d+)$",
        views.PlaceInstanceView.as_view(),
        name="place-detail",
    ),
    url(
        r"^(?P<owner_username>[^/]+)/datasets/(?P<dataset_slug>[^/]+)/places(?:/(?P<pk_list>(?:\d+,)+\d+))?$",
    ...
    url(
        r"^(?P<owner_username>[^/]+)/datasets/(?P<dataset_slug>[^/]+)/mapseed-places.csv",
        views.PlaceListView.as_view(),
        name="place-list",
    ),
    url(
        r"^~/datasets$", views.AdminDataSetListView.as_view(), name="admin-dataset-list"
    ),
    url(r"^nested_admin/", include("nested_admin.urls")),
    url(
        r"^(?P<owner_username>[^/]+)/datasets/(?P<dataset_slug>[^/]+)/keys$",
        views.ApiKeyListView.as_view(),
        name="apikey-list",
    ),
    url(
        r"^(?P<owner_username>[^/]+)/datasets/(?P<dataset_slug>[^/]+)/origins$",
        views.OriginListView.as_view(),
        name="origin-list",
    ),
    url(
        r"^(?P<owner_username>[^/]+)/datasets/(?P<dataset_slug>[^/]+)$",
        views.DataSetInstanceView.as_view(),
        name="dataset-detail",
    ),
    url(
        r"^(?P<owner_username>[^/]+)/datasets/(?P<dataset_slug>[^/]+)/tags/(?P<tag_id>\d+)$",
        views.TagInstanceView.as_view(),
        name="tag-detail",
    ),
    url(
        r"^(?P<owner_username>[^/]+)/datasets/(?P<dataset_slug>[^/]+)/tags$",
        views.TagListView.as_view(),
        name="tag-list",
    ),
    url(
        r"^(?P<owner_username>[^/]+)/datasets/(?P<dataset_slug>[^/]+)/(?P<submission_set_name>[^/]+)(?:/(?P<pk_list>(?:\d+,)+\d+))?$",
        views.DataSetSubmissionListView.as_view(),
        name="dataset-submission-list",
    ),
    url(
        r"^(?P<owner_username>[^/]+)/datasets$",
        views.DataSetListView.as_view(),
        name="dataset-list",
    ),
    url(
        r"^email-template/(?P<email_template_id>\d+)$",
    ...
    url(
        r"^users/login/error/$",
        views.remote_social_login_error,
        name="remote-social-login-error",
    ),
    url(
        r"^users/login/(?P<backend>[^/]+)/$",
        views.remote_social_login,
        name="remote-social-login",
    ),
