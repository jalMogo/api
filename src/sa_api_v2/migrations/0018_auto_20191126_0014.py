...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name="attr_name",
            field=models.CharField(
                db_index=True, max_length=100, verbose_name="Attribute name"
            ),
        ),
        migrations.AlterField(
            model_name="dataindex",
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                blank=True,
                help_text='Either the name of a submission set (e.g. "comments", "tags", or        "places"). Use a "*" to refer to all things.',
                max_length=128,
            ),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            name="event",
            field=models.CharField(
                choices=[("add", "On add")], default="add", max_length=128
            ),
        ),
        migrations.AlterField(
            model_name="placeemailtemplate",
            ...
            field=models.CharField(
                ...
                validators=[
                    django.core.validators.RegexValidator(
                        ...
                        regex=re.compile("^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$", 32),
                    )
                ],
            ),
        ),
