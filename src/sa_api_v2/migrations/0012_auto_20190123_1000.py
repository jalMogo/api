    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(blank=True, max_length=7, null=True, validators=[django.core.validators.RegexValidator(code='invalid', message='Enter a valid color.', regex=re.compile('^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$'))])),
        ...
        migrations.AlterField(
            ...
            name='submission_set',
            field=models.CharField(blank=True, help_text='Either the name of a submission set (e.g., "comments"), "tags", or "places". Leave blank to refer to all things.', max_length=128),
        ),
        migrations.AlterField(
