...
class TagListView(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        queryset = queryset.filter(dataset=dataset).select_related(
...
class PlaceTagListView(
    ...
    **Authentication**: Basic, session, or key auth *(required)*
    ...
    def get_queryset(self):
        ...
        # Do we need to prefetch all of these???
        queryset = queryset.filter(place=place).select_related("place", "submitter")
