...
class SubmissionCache (Cache):
    ...
    def get_other_keys(self, **params):
        dataset_id, place_model_id, submission_set_name = list(map(params.get, ['dataset_id', 'place_id', 'submission_set_name']))
    ...
    def get_request_prefixes(self, **params):
        owner, dataset, place_model, submission_set_name, submission = list(map(params.get, ['owner_username', 'dataset_slug', 'place_id', 'submission_set_name', 'submission_id']))
