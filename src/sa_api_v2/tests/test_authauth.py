...
class CurrentUserViewTests(APITestMixin, TestCase):
    ...
    def test_OPTIONS_is_allowed(self):
        ...
        response = self.client.options(
            "/api/v2/users/current", data={"username": "mjumbewu", "password": "abc123"}
        )
    ...
    def test_preflight_OPTIONS_is_allowed(self):
        ...
        response = self.client.options(
            "/api/v2/users/current",
            data={"username": "mjumbewu", "password": "abc123"},
        ...
        self.assertEqual(
            response["Access-Control-Allow-Methods"], "GET, POST, DELETE, HEAD, OPTIONS"
        )
...
class UserInstanceViewTests(APITestMixin, TestCase):
    ...
    def test_preflight_OPTIONS_is_allowed(self):
        ...
        response = self.client.options(
            "/api/v2/mjumbewu", HTTP_ORIGIN="http://www.example.com"
        )
